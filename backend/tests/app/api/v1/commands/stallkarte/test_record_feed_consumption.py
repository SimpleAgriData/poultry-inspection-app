...
from app.api.v1.commands.stallkarte.record_feed_consumption import RequestBody, handler
...
class TestRecordFeedConsumption:
    @staticmethod
    def test_record_feed_consumption(
        database: Database,
        ...
        assert (
            response.message
            == "Feed consumption recorded successfully on production day '1'"
        )
