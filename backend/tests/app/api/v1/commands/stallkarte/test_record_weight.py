...
from app.api.v1.commands.stallkarte.record_weight import RequestBody, handler
...
class TestRecordWeight:
    ...
    def test_record_weight(
        ...
        assert response.message == "Weight recorded successfully on production day '1'"
