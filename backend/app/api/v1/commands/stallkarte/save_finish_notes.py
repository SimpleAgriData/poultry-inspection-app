...
def handler(
    ...
    events = stallkarte.save_finish_notes(finish_notes=finish_notes)
    ...
    logger.info(f"Finish notes saved for Stallkarte ID '{stallkarte.id}'")

    return MessageResponse(message="Finish notes saved successfully")
